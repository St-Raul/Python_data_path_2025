...
insert into COMPAÑIA values ('D00000004','Telefun','http://www.telefun.com');
insert into COMPAÑIA values ('E00000005','Movilnet','http://www.movilnet.com');


insert into TARIFA values ('joven', 'A00000001','menores de 25 años', 0.25);
insert into TARIFA values ('dío', 'A00000001','la pareja también está en la compañía', 0.20);
...
insert into TARIFA values ('autónomos', 'C00000003','trabajador autçonomo', 0.23);
insert into TARIFA values ('empresa', 'C00000003','todos los empleados están en la compañía', 0.19);
insert into TARIFA values ('estudiante', 'D00000004','descuento para estudiantes', 0.12);
insert into TARIFA values ('premium', 'D00000004','servicio premium', 0.30);
insert into TARIFA values ('básica', 'E00000005','tarifa básica', 0.10);
insert into TARIFA values ('familiar', 'E00000005','plan familiar', 0.18);


insert into CLIENTE values ('35000001P', 'Ramón Martínez Sabina', '12/02/69', 'C/ Melancolía nº 7', '23400', 'Úbeda', 'Jaén');
insert into CLIENTE values ('42000002C', 'José García Márquez', '19/04/87', 'Avda. de Macondo nº 82', '11900', 'San Romón', 'Cádiz');
...
insert into CLIENTE values ('45000005X', 'Laura Fernández López', '05/06/92', 'C/ Sol nº 15', '28013', 'Madrid', 'Madrid');
insert into CLIENTE values ('78000006Y', 'Carlos Pérez Gómez', '22/11/88', 'Avda. del Mar nº 45', '46020', 'Valencia', 'Valencia');
insert into CLIENTE values ('32000007Z', 'Ana Torres Ruiz', '14/03/95', 'C/ Luna nº 8', '29010', 'Málaga', 'Málaga');
...
insert into TELEFONO values ('654567890', '01/01/2010', 'C', 10500, 'D00000004', 'estudiante', '45000005X');
insert into TELEFONO values ('678901234', '15/03/2012', 'T', 2000, 'E00000005', 'básica', '78000006Y');
insert into TELEFONO values ('654678901', '20/07/2015', 'C', 3000, 'D00000004', 'premium', '32000007Z');
...
insert into LLAMADA values ('654567890', '678901234', '15/04/25 14:30:00', 450);
insert into LLAMADA values ('678901234', '654678901', '16/04/25 10:15:00', 120);
insert into LLAMADA values ('654678901', '654567890', '17/04/25 18:45:00', 300);
